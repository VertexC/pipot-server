...
pip install ipaddress enum34 cryptography idna sqlalchemy twisted pyopenssl flask-sqlalchemy flask flask-login passlib pymysql service_identity pycrypto flask-wtf netifaces gunicorn >> "$install_log" 2>&1
echo ""
echo "-------------------------------"
